...
Extentions to these standards (ISO 9899:1999 etc.), *secure* / [*bounds checking interface*](http://www.open-std.org/jtc1/sc22/wg14/www/docs/n1570.pdf) functions xxxx_s from C11, Annex K, [POSIX](https://en.wikipedia.org/wiki/C_POSIX_library) functions or  Microsoft specific add-ons will not be implemented into "torito C Library".
