...
a very famous `kbhit()` (check for keystroke at console [<sup>1</sup>](https://github.com/JoaquinConoBolillo/torito-C-Library/blob/master/README.md#1) ) and fopen()-mode-strings like `"rt"`, `"wt"`
